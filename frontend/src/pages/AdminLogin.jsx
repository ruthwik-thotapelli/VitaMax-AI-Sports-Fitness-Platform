    ...
    <div className="min-h-screen bg-brand-navy flex items-center justify-center p-6 md:p-12 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div 
          ...
          className="absolute top-[-20%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-red-600/30 blur-[140px] mix-blend-screen"
        />
        <motion.div 
          animate={{ 
            scale: [1, 1.3, 1],
          ...
          className="absolute bottom-[-20%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-brand-orange/30 blur-[130px] mix-blend-screen"
        />
        <motion.div 
          animate={{ 
            scale: [1, 1.1, 1],
          ...
          className="absolute top-[30%] left-[20%] w-[40vw] h-[40vw] rounded-full bg-brand-blue/20 blur-[100px] mix-blend-screen"
        />
      ...
      >
        ...
        <div className="hidden md:flex flex-col justify-between p-12 rounded-[2rem] bg-white/[0.03] border border-white/10 backdrop-blur-[40px] shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-16">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-b from-brand-orange to-red-600 flex items-center justify-center text-white shadow-[0_0_30px_rgba(255,107,0,0.4)]">
            ...
            <h1 className="text-5xl font-bold tracking-tight text-white leading-[1.1] mb-6 drop-shadow-lg">
              System<br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange via-red-500 to-brand-orange bg-[length:200%_auto] animate-gradient">
                Command Center
              </span>
            </h1>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 bg-black/20 p-4 rounded-2xl border border-white/5 backdrop-blur-md transition-all hover:bg-black/30">
                <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 text-brand-orange shadow-[inset_0_0_20px_rgba(255,255,255,0.05)]">
                  <Server size={20} />
                </div>
                <div>
                  <p className="text-sm font-bold text-white">Infrastructure</p>
                  <p className="text-xs text-gray-400 mt-1">Manage server allocations</p>
                </div>
              </div>
              <div className="flex items-center gap-4 bg-black/20 p-4 rounded-2xl border border-white/5 backdrop-blur-md transition-all hover:bg-black/30">
                ...
                <div>
                  <p className="text-sm font-bold text-white">Data Integrity</p>
                  <p className="text-xs text-gray-400 mt-1">Monitor core databases</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center p-8 md:p-12 rounded-[2rem] bg-black/40 border border-white/10 backdrop-blur-[40px] shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] relative">
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-white tracking-tight mb-2 drop-shadow-md">Authenticate</h2>
            <p className="text-sm text-gray-400">Enter your admin credentials to access the grid.</p>
          </div>
          ...
          {successMessage && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-8 p-4 rounded-xl bg-brand-lime/10 border border-brand-lime/20 flex items-center gap-3 backdrop-blur-md"
            >
              <ShieldCheck className="text-brand-lime shrink-0" size={18} />
              <p className="text-sm text-brand-lime font-bold">{successMessage}</p>
            </motion.div>
          )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-14 bg-black/40 border border-white/10 focus:border-brand-orange/50 focus:bg-black/60 rounded-xl pl-12 pr-4 text-sm text-white font-medium outline-none transition-all placeholder:text-gray-600 focus:shadow-[0_0_20px_rgba(255,107,0,0.15)]"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-14 bg-black/40 border border-white/10 focus:border-red-500/50 focus:bg-black/60 rounded-xl pl-12 pr-4 text-sm text-white font-medium outline-none transition-all placeholder:text-gray-600 focus:shadow-[0_0_20px_rgba(239,68,68,0.15)]"
                  placeholder="••••••••"
                />
              </div>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-gray-500 font-medium">
              Need access?{' '}
              <Link to="/admin/register" className="text-white font-bold hover:text-brand-orange transition-colors">
                Request Clearance
              </Link>
            </p>
          </div>
